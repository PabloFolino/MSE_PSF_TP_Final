...
#    fftAxe.set_ylim ( 0,np.clip(np.max(ciaaFFT),0.01,100))
    ...
    cutFrecZoneLn = fftAxe.fill_between([-cutFrec,-cutFrec2],100,-100,facecolor="yellow",alpha=0.5)
    cutFrecZoneLn = fftAxe.fill_between([cutFrec2,cutFrec],100,-100,facecolor="yellow",alpha=0.5)
