...
#define CUTFREC 	5100 	// Frecuencia de corte superior del filtro
#define CUTFREC2	350		// Frecuencia de corte inferior del filtro

#define NIVEL_RUIDO 1		// Umbral de ruido
...
struct header_struct header={"*header*",0,128,12000,CUTFREC,CUTFREC2,ON,h_LENGTH,"end*"};
...
//   arm_cmplx_mag_squared_q15 ( H ,HAbs ,(header.N+h_LENGTH-1 ));
   ...
   header.Ruido=false;			// Se usa para verificar si hay ruido a partir de un nivel --> NIVEL_RUIDO
